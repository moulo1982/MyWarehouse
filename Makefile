...
SOURCEFILES := Base64.cpp client.cpp client_manager.cpp http_parser/http_parser.c http_server.cpp http_session.cpp io_service_pool.cpp LogWrapper.cpp UCludeProject.cpp
EXTERNAL_LIBS := 
...
$(BINARYDIR)/http_parser.o : http_parser/http_parser.c $(all_make_files) |$(BINARYDIR)
	$(CC) $(CFLAGS) -c $< -o $@ -MD -MF $(@:.o=.dep)
